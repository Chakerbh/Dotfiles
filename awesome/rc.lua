...
-- {{{ Tags
tags = {
   names = { "web", "term", "irc", "media", "files", "other" },
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ altkey }, "m",
        function ()
            os.execute("amixer set Headphone toggle && amixer set Master toggle && amixer set Speaker toggle")
            volumewidget.update()
        end),
